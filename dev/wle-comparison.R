## WLE against MAP, and against TAM and mirt
##
## Simulates across item counts, true and fitted parameter counts, and known
## versus estimated items, then compares weighted-likelihood and MAP ability
## estimates. Uses future for the sweep and ggpointdensity for the plots.
##
## Lifted verbatim out of tests/testthat/test-ability.R, where it sat inside an
